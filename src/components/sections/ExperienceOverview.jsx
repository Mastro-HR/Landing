        ...
        <div className="py-16 sm:py-20 lg:py-28">
          <motion.div
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6">
              <Link
                to="/demo"
                className="group relative overflow-hidden px-5 sm:px-6 py-2.5 sm:py-3 rounded-full bg-primary-50 text-teal-700 font-medium text-base sm:text-lg hover:shadow-xl hover:shadow-accent-500/20 transition-all duration-300 flex items-center gap-2">
