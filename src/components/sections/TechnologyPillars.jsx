      ...
      >
        <div className="relative z-10 h-full flex flex-col">
          <div className="flex items-start justify-between mb-6">
            <motion.div 
              className="w-14 h-14 sm:w-16 sm:h-16 rounded-xl 
                        bg-gradient-to-br from-accent-500/10 to-accent-400/10 
          ...
          <h3 className="text-xl sm:text-2xl font-semibold text-primary-900 
                       group-hover:text-accent-600 transition-colors duration-300 mb-4">
            {title}
          </h3>
              ...
              {tags.map((tag, idx) => (
                <motion.span
                  ...
                  className="bg-primary-50/80 text-primary-600 rounded-full px-3 py-1 
                           text-sm font-medium whitespace-nowrap border border-primary-100
          ...
          <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16 lg:mb-20">
            ...
            >
              <div className="inline-flex items-center px-4 py-2 rounded-full 
                            bg-accent-500/10 text-accent-600 mb-4 backdrop-blur-sm">
