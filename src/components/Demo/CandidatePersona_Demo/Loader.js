...
const TRANSLATIONS = {
  en: {
    steps: [
      ...
      { id: 'processing', message: 'Processing candidate requirements...' },
      { id: 'finalizing', message: 'Finalizing executive profile...' }
    ],
    complete: 'Complete!',
  ...
  it: {
    steps: [
      ...
      { id: 'processing', message: 'Elaborazione requisiti candidato ideale...' },
      { id: 'finalizing', message: 'Finalizzazione profilo esecutivo...' }
    ],
    complete: 'Completato!',
