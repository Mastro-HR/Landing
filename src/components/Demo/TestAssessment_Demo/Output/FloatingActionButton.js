...
const FloatingActionButton = ({ label, onClick }) => (
  <div className="fixed bottom-6 right-6 md:right-8 lg:right-12">
    <button
      onClick={onClick}
      className="flex items-center gap-2 bg-accent-600 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg shadow-lg hover:bg-accent-700 transition-all focus:outline-none"
    >
